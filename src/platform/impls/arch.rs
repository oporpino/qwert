...
impl InstallerOps for Arch {
    ...
    fn zsh_completion_path(&self) -> PathBuf {
        PathBuf::from("/usr/share/zsh/site-functions/_qwert")
    }

    fn bash_completion_path(&self) -> Option<PathBuf> {
        Some(PathBuf::from("/usr/share/bash-completion/completions/qwert"))
    }
